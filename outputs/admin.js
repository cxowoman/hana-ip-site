...
const contentSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      ["about.storyEyebrow", "故事小標", "text", "About Me"],
      ["about.storyTitle", "故事標題", "textarea", "用 AI 放大影響力，\n用社群創造成交，\n把收入成長做成可複製的系統。"],
      ["about.story1", "故事段落 1", "textarea", "我是涵捺 Hana，收入成長顧問 × 商業營收成長專家，擁有 20 年創業經歷與 10 年以上電商、行銷實戰經驗。從品牌經營、商品銷售、社群流量到團隊營運，我專注協助個人品牌、創業者與中小企業，找出收入停滯的真正原因，建立更穩定、更有效率的成長路徑。"],
      ["about.story2", "故事段落 2", "textarea", "我的顧問與培訓涵蓋 AI 內容策略、社群漏斗、商品變現設計、成交路徑與數據優化。我協助你把工具串成一套完整的商業流程，讓每一則內容、每一次社群互動，都能更接近名單、成交與回購。"],
      ["about.story3", "故事段落 3", "textarea", "我相信，真正的收入成長，不是讓自己變得更忙，也不是只靠一支爆紅影片，而是找到對的定位、設計對的商品，並讓內容、社群、AI 與團隊資源彼此放大。若你正面臨流量不穩、社群有人卻無法成交，或想建立穩定的第二收入，我會陪你重新盤點現有資源，把流量變成信任、把信任變成成交，打造一套屬於你、可以追蹤、可以優化、也可以複製的收入成長系統。"],
      ["about.cta", "故事按鈕", "text", "預約收入成長診斷"],
    ],
  },
  {
    id: "experience",
